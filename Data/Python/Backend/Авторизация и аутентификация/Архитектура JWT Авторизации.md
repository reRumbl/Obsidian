**Авторизация JWT — это механизм аутентификации и авторизации без сохранения состояния** , который устраняет необходимость в сеансах и файлах cookie. Он использует для обмена данными JWT-токены.
