В [[SQLAlchemy|SQLAlchemy]] можно делать как сырые [[IT/Базы данных/SQL/SQL|SQL]] запросы через движок, так и построенные запросы. Сырые запросы делаются при помощи простой конструкции с методом execute и требуют полностью писать запрос на [[IT/Базы данных/SQL/SQL|SQL]], а построенные запросы происходят при помощи [[SQLAlchemy ORM| SQLAlchemy ORM]] и методов в специальных [[Классы|классах]].
